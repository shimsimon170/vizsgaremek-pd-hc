...
public Customers(Integer id) {
    ...
    public String toString() {
        return "com.mycompany.yumeneko.Model.Customers[ id=" + id + " ]";
    }
        ...
        try {
            ...
            for(Object[] o : resultList){
                Customers u = new Customers(
                        ...
                        o[9] == null ? null : formatter.parse(o[8].toString())
                );
                toReturn = u;
            }
    ...
    public Boolean registerAdmin(Customers u) {
        EntityManager em = emf.createEntityManager();
    ...
    public static List<Customers> getAllUser() {
        EntityManager em = emf.createEntityManager();
        List<Customers> userList = null;
        
        try {
            StoredProcedureQuery spq = em.createStoredProcedureQuery("getAllUser");
            spq.execute();
            
            List<Customers>toReturn=new ArrayList();
            List<Object[]>resultList =spq.getResultList();
            SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            ...
            for(Object[] record : resultList){
                Customers u =new Customers(
                        ...
                        record[9] == null ? null : formatter.parse(record[8].toString())
    ...
    public Boolean changePassword(Integer userId, String newPassword, Integer creator) {
        ...
        try {
            ...
            spq.registerStoredProcedureParameter("creatorIN", String.class, ParameterMode.IN);
