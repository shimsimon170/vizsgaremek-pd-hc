...
<body>
    ...
    <div class="menuContainer">
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid menuHero">
          <h1 class="fs-1">Yume Neko Menu</h1>
            <br>
        ...
        <div class="container-fluid categorised">
            ...
            <div class="row popular" id="popular">
              <h1 id="items" class="menu-title">Popular Items</h1>
                <div class="col-lg-6">
                    <div class="small">
                      <img src="./img/menuSushi.jpg" alt="">
                      <h3 class="popular-item-title">Neko Sushi bowl</h3>
                    </div>
                </div>
                <div class="col-lg-6">
                  <div class="small">
                    <img src="./img/menuMatcha.jpg" alt="">
                    <h3 class="popular-item-title">Neko Matcha tea</h3>
                  </div>
                  <div class="small">
                    <img src="./img/menuRamen.jpg" alt="">
                    <h3 class="popular-item-title">Neko Ramen bowl</h3>
                  </div>
                </div>
            </div>
        </div>
